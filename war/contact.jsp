...
<body>
    ...
    <header class="intro-header" style="background-image: url('img/pogs.jpg')">
        <div class="container">
            <div class="row">
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <table>
                    <tr>
                        <td >
                            <img height="150px" width="150px" src="img/sonic.png"/>
                        </td>
                        <td>
                            <ul>
                                <li>Jeremy Clifton</li>
                                <li>Senior at <i> University of Texas </i></li>
                                <li> <i> jclifton44@gmail.com</i></li>
                            </ul>
                        </td>
                    </tr>
                    <tr>
                        <td >
                            <img height="150px" width="150px" src="img/midorima.png"/>
                        </td>
                        <td>
                            <ul>
                                <li>Safeen Ali</li>
                                <li>Junior at <i> University of Texas </i></li>
                                <li> <i> safeen713@gmail.com</i></li>
                            </ul>
                        </td>
                    </tr>
