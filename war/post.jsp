                ...
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="post-heading">
                        ...
                        <h1> Post a blog entry.</h1>
                            <table>
                                <tr>
                                    <td> <h3 style="color:#fff"/>Title: </h3></td>
                                    <td>&nbsp;&nbsp;&nbsp;<input  id="title" type="text" name="title" /></td>
                                </tr>
                                <tr>
                                    <td > <h3 style="color:#fff"/>Post: </h3></td>
                                    <td>&nbsp;&nbsp;&nbsp;<textarea cols="50" id="post" rows="4" name="post"></textarea></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;&nbsp;&nbsp;<input type="submit" onclick="doPost()" id="postToBlog" value="Post"/><span  id="redMessage" style="display:none; font-family: 'Open Sans','Helvetica Neue',Helvetica,Arial,sans-serif; color: #FFF;">Please enter title and post content.</span></td>
                                </tr>
                            </table>
                        <% } else { %>

                        <h4> Please Sign in to post </h4>
                        <% } %>
